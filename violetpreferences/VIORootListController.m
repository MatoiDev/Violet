...
-(void)viewDidLoad {
    ...
    self.appearanceSettings = [VIOMainNavigationBarAppearance new];
    ...
    [[self VioletLabel] setTextColor:[UIColor whiteColor]];
    ...
    [[self VioletVersionLabel] setTextColor:[UIColor whiteColor]];
    ...
    self.PBHeaderImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/VioletPreferences.bundle/logo.png"];;
...
//
//    CGFloat currentScrollViewYPosition = scrollView.contentOffset.y;
//
//    if (currentScrollViewYPosition > 100)
